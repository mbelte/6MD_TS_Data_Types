...
const productsTitles = getTitles(products)
...
const productPrice = formatPrice(products[0])
...
let price: number = 0 /* add the correcy type annotation here instead of any */
price = 100.5
...
const productName = anyProduct.name
const priceWithTaxes = anyProduct.price * 1.25
const upperCaseName = anyProduct.name.toUpperCase()
...
//  Why?
const getCurrency = (account: {currency: string}) => account.currency
...
const someAccount: AccountWithoutID = {
